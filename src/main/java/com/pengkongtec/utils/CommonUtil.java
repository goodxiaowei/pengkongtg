...
import com.pengkongtec.config.exception.CommonJsonException;
...
public class CommonUtil {
    ...
    /**
     * 返回一个returnData为空对象的失败消息的json
     *
     * @return
     */
    public static JSONObject failJson() {
        return failJson(new JSONObject());
    }
     ...
     * @return
     */
    public static JSONObject failJson(Object returnData) {
        JSONObject resultJson = new JSONObject();
        resultJson.put("returnCode", Constants.FAIL_CODE);
        resultJson.put("returnMsg", Constants.FAIL_MSG);
        resultJson.put("returnData", returnData);
        return resultJson;
    }
     ...
     * @return
     */
    public static JSONObject failJson(String returnMsg) {
        JSONObject resultJson = new JSONObject();
        resultJson.put("returnCode", Constants.FAIL_CODE);
        resultJson.put("returnMsg", returnMsg);
        resultJson.put("returnData", new Object());
        return resultJson;
    }
